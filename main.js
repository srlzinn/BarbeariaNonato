...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (btnAgendar) {
        btnAgendar.addEventListener('click', function(e) {
            ...
            const profissional = document.getElementById('profissional')?.value?.trim() || 'Qualquer';
            // Nova verificação para impedir datas anteriores
            ...
            let mensagem = `Olá! \n\nGostaria de agendar um horário na Barbearia do Nonato.\n\n*Serviço:* ${servico}\n*Data:* ${dataFormatada}\n*Horário:* ${horario}\n*Profissional:* ${profissional}\n\nAgradeço a atenção e aguardo confirmação.`;
